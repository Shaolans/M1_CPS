...
#define nstates1	143	/* laby */
#define minseq1	13
#define maxseq1	154
#define endstate1	142

#define nstates0	14	/* observateur */
#define minseq0	0
#define maxseq0	12
#define endstate0	13
...
#define Plaby	((P1 *)this)
typedef struct P1 { /* laby */
...
#define Pobservateur	((P0 *)this)
typedef struct P0 { /* observateur */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, dir) - 1*sizeof(uchar))

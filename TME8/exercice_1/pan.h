...
#define _nstates1	23	/* observer */
#define minseq1	50
#define maxseq1	71
#define _endstate1	22

#define _nstates0	51	/* traffic_light */
#define minseq0	0
#define maxseq0	49
...
#define Pobserver	((P1 *)this)
typedef struct P1 { /* observer */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air1	(sizeof(P1) - Offsetof(P1, col) - 1*sizeof(uchar))

#define Ptraffic_light	((P0 *)this)
typedef struct P0 { /* traffic_light */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY

...
short src_ln1 [] = {
	  0,  42,  43,  44,  47,  50,  50,  51, 
	 51,  51,  49,  53,  53,  53,  46,  55, 
	 55,  56,  57,  59,  59,  60,  61,  62, 
	 63,  63,  41,  65,  41,  66,  66,   0, };
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "mutex2.pml", 1, 30 },
	{ "-", 31, 32 }
...
short src_ln0 [] = {
	  0,  11,  12,  13,  16,  19,  19,  20, 
	 20,  20,  18,  22,  22,  22,  15,  24, 
	 24,  25,  26,  28,  28,  29,  31,  33, 
	 34,  34,  10,  36,  10,  37,  37,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "mutex2.pml", 1, 30 },
	{ "-", 31, 32 }
...
{	int j, h = now._nr_pr;
	...
	case 1:	/* proc2 */
		...
		((P1 *)pptr(h))->max_sleep = par1;
		/* locals: */
		((P1 *)pptr(h))->count = 0;
		((P1 *)pptr(h))->msec = ((P1 *)this)->max_sleep;
#ifdef VAR_RANGES
		logval("proc2:repeat", ((P1 *)pptr(h))->repeat);
		logval("proc2:max_sleep", ((P1 *)pptr(h))->max_sleep);
		logval("proc2:count", ((P1 *)pptr(h))->count);
		logval("proc2:msec", ((P1 *)pptr(h))->msec);
#endif
#ifdef HAS_CODE
		locinit1(h);
#endif
	...
	case 0:	/* proc1 */
		...
		((P0 *)pptr(h))->max_sleep = par1;
		/* locals: */
		((P0 *)pptr(h))->count = 0;
		((P0 *)pptr(h))->msec = ((P0 *)this)->max_sleep;
#ifdef VAR_RANGES
		logval("proc1:repeat", ((P0 *)pptr(h))->repeat);
		logval("proc1:max_sleep", ((P0 *)pptr(h))->max_sleep);
		logval("proc1:count", ((P0 *)pptr(h))->count);
		logval("proc1:msec", ((P0 *)pptr(h))->msec);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
...
{	/* int i; */
	...
	printf("	int    repeat:	%d\n", ((P1 *)pptr(pid))->repeat);
	printf("	int    max_sleep:	%d\n", ((P1 *)pptr(pid))->max_sleep);
	printf("	int    count:	%d\n", ((P1 *)pptr(pid))->count);
	printf("	int    msec:	%d\n", ((P1 *)pptr(pid))->msec);
		break;
	case 0:

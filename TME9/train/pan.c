...
short src_ln0 [] = {
	  0,   6,   9,  10,  13,  15,  15,  16, 
	 16,  14,  19,  20,  21,  25,  26,  24, 
	 28,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "train.pml", 1, 16 },
...
{	int j, h = now._nr_pr;
	...
	case 4:	/* :init: */
		...
		/* params: */
		/* locals: */
		((P4 *)pptr(h))->change1 = addqueue(calling_pid, 1, 1);
		((P4 *)pptr(h))->sense_in1 = addqueue(calling_pid, 2, 1);
		((P4 *)pptr(h))->sense_out1 = addqueue(calling_pid, 3, 1);
		((P4 *)pptr(h))->change2 = addqueue(calling_pid, 4, 1);
		((P4 *)pptr(h))->sense_in2 = addqueue(calling_pid, 5, 1);
		((P4 *)pptr(h))->sense_out2 = addqueue(calling_pid, 6, 1);
		((P4 *)pptr(h))->switch1 = addqueue(calling_pid, 7, 1);
		((P4 *)pptr(h))->switch2 = addqueue(calling_pid, 8, 1);
		((P4 *)pptr(h))->signalin1 = addqueue(calling_pid, 9, 1);
		((P4 *)pptr(h))->signalin2 = addqueue(calling_pid, 10, 1);
		((P4 *)pptr(h))->signalout1 = addqueue(calling_pid, 11, 1);
		((P4 *)pptr(h))->signalout2 = addqueue(calling_pid, 12, 1);
#ifdef VAR_RANGES
#endif
#ifdef HAS_CODE
		locinit4(h);
	...
	case 3:	/* sensor */
		...
		reached3[3]=1;
		/* params: */
		((P3 *)pptr(h))->sense = par0;
		((P3 *)pptr(h))->signal = par1;
		/* locals: */
		((P3 *)pptr(h))->b = 0;
#ifdef VAR_RANGES
		logval("sensor:b", ((P3 *)pptr(h))->b);
#endif
#ifdef HAS_CODE
		locinit3(h);
#endif
	...
	case 2:	/* feu */
		...
		reached2[1]=1;
		/* params: */
		((P2 *)pptr(h))->switch = par0;
		((P2 *)pptr(h))->change = par1;
		/* locals: */
		((P2 *)pptr(h))->b = 0;
		((P2 *)pptr(h))->color = 0;
#ifdef VAR_RANGES
		logval("feu:b", ((P2 *)pptr(h))->b);
		logval("feu:color", ((P2 *)pptr(h))->color);
#endif
#ifdef HAS_CODE
		locinit2(h);
#endif
	...
	case 1:	/* controle */
		...
		reached1[1]=1;
		/* params: */
		((P1 *)pptr(h))->signalin1 = par0;
		((P1 *)pptr(h))->signalin2 = par1;
		((P1 *)pptr(h))->signalout1 = par2;
		((P1 *)pptr(h))->signalout2 = par3;
		((P1 *)pptr(h))->switch1 = par4;
		((P1 *)pptr(h))->switch2 = par5;
		/* locals: */
		((P1 *)pptr(h))->b = 0;
#ifdef VAR_RANGES
		logval("controle:b", ((P1 *)pptr(h))->b);
#endif
#ifdef HAS_CODE
		locinit1(h);
#endif
	...
	case 0:	/* train */
		...
		reached0[2]=1;
		/* params: */
		((P0 *)pptr(h))->change = par0;
		((P0 *)pptr(h))->sense_in = par1;
		((P0 *)pptr(h))->sense_out = par2;
		/* locals: */
		((P0 *)pptr(h))->color = 0;
#ifdef VAR_RANGES
		logval("train:color", ((P0 *)pptr(h))->color);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
...
#include PROV
	...
	Maxbody = max(Maxbody, ((int) sizeof(Q12)));
...
{	int i = 0;
	...
	{	if (t->ty[i] == TIMEOUT_F) return 1;
		...
		switch (t->qu[i]) {
		case 0: break;
		case 1: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P0 *)this)->change) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P0 *)this)->change) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P0 *)this)->change) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P0 *)this)->change) )))
			    ) return 0; break;
		case 2: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P0 *)this)->sense_in) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P0 *)this)->sense_in) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P0 *)this)->sense_in) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P0 *)this)->sense_in) )))
			    ) return 0; break;
		case 3: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P0 *)this)->sense_out) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P0 *)this)->sense_out) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P0 *)this)->sense_out) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P0 *)this)->sense_out) )))
			    ) return 0; break;
		case 4: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P1 *)this)->signalin1) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P1 *)this)->signalin1) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P1 *)this)->signalin1) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P1 *)this)->signalin1) )))
			    ) return 0; break;
		case 5: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P1 *)this)->signalin2) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P1 *)this)->signalin2) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P1 *)this)->signalin2) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P1 *)this)->signalin2) )))
			    ) return 0; break;
		case 6: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P1 *)this)->signalout1) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P1 *)this)->signalout1) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P1 *)this)->signalout1) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P1 *)this)->signalout1) )))
			    ) return 0; break;
		case 7: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P1 *)this)->signalout2) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P1 *)this)->signalout2) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P1 *)this)->signalout2) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P1 *)this)->signalout2) )))
			    ) return 0; break;
		case 8: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P1 *)this)->switch1) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P1 *)this)->switch1) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P1 *)this)->switch1) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P1 *)this)->switch1) )))
			    ) return 0; break;
		case 9: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P1 *)this)->switch2) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P1 *)this)->switch2) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P1 *)this)->switch2) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P1 *)this)->switch2) )))
			    ) return 0; break;
		case 10: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P2 *)this)->switch) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P2 *)this)->switch) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P2 *)this)->switch) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P2 *)this)->switch) )))
			    ) return 0; break;
		case 11: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P2 *)this)->change) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P2 *)this)->change) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P2 *)this)->change) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P2 *)this)->change) )))
			    ) return 0; break;
		case 12: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P3 *)this)->sense) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P3 *)this)->sense) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P3 *)this)->sense) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P3 *)this)->sense) )))
			    ) return 0; break;
		case 13: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P3 *)this)->signal) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P3 *)this)->signal) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P3 *)this)->signal) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P3 *)this)->signal) )))
			    ) return 0; break;
		case 14: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P4 *)this)->change1) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P4 *)this)->change1) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P4 *)this)->change1) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P4 *)this)->change1) )))
			    ) return 0; break;
		case 15: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P4 *)this)->sense_in1) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P4 *)this)->sense_in1) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P4 *)this)->sense_in1) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P4 *)this)->sense_in1) )))
			    ) return 0; break;
		case 16: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P4 *)this)->sense_out1) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P4 *)this)->sense_out1) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P4 *)this)->sense_out1) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P4 *)this)->sense_out1) )))
			    ) return 0; break;
		case 17: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P4 *)this)->change2) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P4 *)this)->change2) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P4 *)this)->change2) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P4 *)this)->change2) )))
			    ) return 0; break;
		case 18: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P4 *)this)->sense_in2) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P4 *)this)->sense_in2) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P4 *)this)->sense_in2) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P4 *)this)->sense_in2) )))
			    ) return 0; break;
		case 19: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P4 *)this)->sense_out2) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P4 *)this)->sense_out2) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P4 *)this)->sense_out2) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P4 *)this)->sense_out2) )))
			    ) return 0; break;
		case 20: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P4 *)this)->switch1) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P4 *)this)->switch1) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P4 *)this)->switch1) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P4 *)this)->switch1) )))
			    ) return 0; break;
		case 21: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P4 *)this)->switch2) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P4 *)this)->switch2) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P4 *)this)->switch2) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P4 *)this)->switch2) )))
			    ) return 0; break;
		case 22: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P4 *)this)->signalin1) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P4 *)this)->signalin1) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P4 *)this)->signalin1) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P4 *)this)->signalin1) )))
			    ) return 0; break;
		case 23: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P4 *)this)->signalin2) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P4 *)this)->signalin2) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P4 *)this)->signalin2) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P4 *)this)->signalin2) )))
			    ) return 0; break;
		case 24: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P4 *)this)->signalout1) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P4 *)this)->signalout1) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P4 *)this)->signalout1) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P4 *)this)->signalout1) )))
			    ) return 0; break;
		case 25: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P4 *)this)->signalout2) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P4 *)this)->signalout2) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P4 *)this)->signalout2) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P4 *)this)->signalout2) )))
			    ) return 0; break;
...
{	/* int i; */
	...
	printf("	chan change1 (=%d):	len %d:\t", ((P4 *)pptr(pid))->change1, q_len(((P4 *)pptr(pid))->change1));
	c_chandump(((P4 *)pptr(pid))->change1);
	printf("	chan sense_in1 (=%d):	len %d:\t", ((P4 *)pptr(pid))->sense_in1, q_len(((P4 *)pptr(pid))->sense_in1));
	c_chandump(((P4 *)pptr(pid))->sense_in1);
	printf("	chan sense_out1 (=%d):	len %d:\t", ((P4 *)pptr(pid))->sense_out1, q_len(((P4 *)pptr(pid))->sense_out1));
	c_chandump(((P4 *)pptr(pid))->sense_out1);
	printf("	chan change2 (=%d):	len %d:\t", ((P4 *)pptr(pid))->change2, q_len(((P4 *)pptr(pid))->change2));
	c_chandump(((P4 *)pptr(pid))->change2);
	printf("	chan sense_in2 (=%d):	len %d:\t", ((P4 *)pptr(pid))->sense_in2, q_len(((P4 *)pptr(pid))->sense_in2));
	c_chandump(((P4 *)pptr(pid))->sense_in2);
	printf("	chan sense_out2 (=%d):	len %d:\t", ((P4 *)pptr(pid))->sense_out2, q_len(((P4 *)pptr(pid))->sense_out2));
	c_chandump(((P4 *)pptr(pid))->sense_out2);
	printf("	chan switch1 (=%d):	len %d:\t", ((P4 *)pptr(pid))->switch1, q_len(((P4 *)pptr(pid))->switch1));
	c_chandump(((P4 *)pptr(pid))->switch1);
	printf("	chan switch2 (=%d):	len %d:\t", ((P4 *)pptr(pid))->switch2, q_len(((P4 *)pptr(pid))->switch2));
	c_chandump(((P4 *)pptr(pid))->switch2);
	printf("	chan signalin1 (=%d):	len %d:\t", ((P4 *)pptr(pid))->signalin1, q_len(((P4 *)pptr(pid))->signalin1));
	c_chandump(((P4 *)pptr(pid))->signalin1);
	printf("	chan signalin2 (=%d):	len %d:\t", ((P4 *)pptr(pid))->signalin2, q_len(((P4 *)pptr(pid))->signalin2));
	c_chandump(((P4 *)pptr(pid))->signalin2);
	printf("	chan signalout1 (=%d):	len %d:\t", ((P4 *)pptr(pid))->signalout1, q_len(((P4 *)pptr(pid))->signalout1));
	c_chandump(((P4 *)pptr(pid))->signalout1);
	printf("	chan signalout2 (=%d):	len %d:\t", ((P4 *)pptr(pid))->signalout2, q_len(((P4 *)pptr(pid))->signalout2));
	c_chandump(((P4 *)pptr(pid))->signalout2);
		break;
	case 3:
		printf("local vars proc %d (sensor):\n", pid);
	printf("	chan sense (=%d):	len %d:\t", ((P3 *)pptr(pid))->sense, q_len(((P3 *)pptr(pid))->sense));
	c_chandump(((P3 *)pptr(pid))->sense);
	printf("	chan signal (=%d):	len %d:\t", ((P3 *)pptr(pid))->signal, q_len(((P3 *)pptr(pid))->signal));
	c_chandump(((P3 *)pptr(pid))->signal);
	printf("	bit    b:	%d\n", ((P3 *)pptr(pid))->b);
		break;
	case 2:
		printf("local vars proc %d (feu):\n", pid);
	printf("	chan switch (=%d):	len %d:\t", ((P2 *)pptr(pid))->switch, q_len(((P2 *)pptr(pid))->switch));
	c_chandump(((P2 *)pptr(pid))->switch);
	printf("	chan change (=%d):	len %d:\t", ((P2 *)pptr(pid))->change, q_len(((P2 *)pptr(pid))->change));
	c_chandump(((P2 *)pptr(pid))->change);
	printf("	bit    b:	%d\n", ((P2 *)pptr(pid))->b);
		break;
	case 1:
		printf("local vars proc %d (controle):\n", pid);
	printf("	chan signalin1 (=%d):	len %d:\t", ((P1 *)pptr(pid))->signalin1, q_len(((P1 *)pptr(pid))->signalin1));
	c_chandump(((P1 *)pptr(pid))->signalin1);
	printf("	chan signalin2 (=%d):	len %d:\t", ((P1 *)pptr(pid))->signalin2, q_len(((P1 *)pptr(pid))->signalin2));
	c_chandump(((P1 *)pptr(pid))->signalin2);
	printf("	chan signalout1 (=%d):	len %d:\t", ((P1 *)pptr(pid))->signalout1, q_len(((P1 *)pptr(pid))->signalout1));
	c_chandump(((P1 *)pptr(pid))->signalout1);
	printf("	chan signalout2 (=%d):	len %d:\t", ((P1 *)pptr(pid))->signalout2, q_len(((P1 *)pptr(pid))->signalout2));
	c_chandump(((P1 *)pptr(pid))->signalout2);
	printf("	chan switch1 (=%d):	len %d:\t", ((P1 *)pptr(pid))->switch1, q_len(((P1 *)pptr(pid))->switch1));
	c_chandump(((P1 *)pptr(pid))->switch1);
	printf("	chan switch2 (=%d):	len %d:\t", ((P1 *)pptr(pid))->switch2, q_len(((P1 *)pptr(pid))->switch2));
	c_chandump(((P1 *)pptr(pid))->switch2);
	printf("	bit    b:	%d\n", ((P1 *)pptr(pid))->b);
		break;
	case 0:
		printf("local vars proc %d (train):\n", pid);
	printf("	chan change (=%d):	len %d:\t", ((P0 *)pptr(pid))->change, q_len(((P0 *)pptr(pid))->change));
	c_chandump(((P0 *)pptr(pid))->change);
	printf("	chan sense_in (=%d):	len %d:\t", ((P0 *)pptr(pid))->sense_in, q_len(((P0 *)pptr(pid))->sense_in));
	c_chandump(((P0 *)pptr(pid))->sense_in);
	printf("	chan sense_out (=%d):	len %d:\t", ((P0 *)pptr(pid))->sense_out, q_len(((P0 *)pptr(pid))->sense_out));
	c_chandump(((P0 *)pptr(pid))->sense_out);
		break;
	}
}
void
...
{	uchar *z; int slot;
	...
	case 8:
		...
		{	printf(" [");
			printm(((Q8 *)z)->contents[slot].fld0);
			printf("],");
		}
		break;
	case 7:
		...
		{	printf(" [");
			printm(((Q7 *)z)->contents[slot].fld0);
			printf("],");
		}
		break;
	case 6:

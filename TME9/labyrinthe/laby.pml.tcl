...
.c create text 300 8 -text "1:laby"
...
.c create text 300 32 -text "go!ENTER"
...
.c create text 140 56 -text "go?ENTER"
...
.c create text 140 80 -text "go ENTER"
...
.c create rectangle 268 886 332 906 -fill white -width 0
.c create text 300 896 -text "go!WEST"
...
.c create rectangle 108 910 172 930 -fill white -width 0
.c create text 140 920 -text "go?WEST"
...
.c create rectangle 103 934 177 954 -fill white -width 0
.c create text 140 944 -text "go WEST"
...
.c create rectangle 263 1030 337 1050 -fill white -width 0
.c create text 300 1040 -text "go!NORTH"
...
.c create rectangle 103 1054 177 1074 -fill white -width 0
.c create text 140 1064 -text "go?NORTH"
...
.c create rectangle 98 1078 182 1098 -fill white -width 0
.c create text 140 1088 -text "go NORTH"
...
.c create rectangle 268 1102 332 1122 -fill white -width 0
.c create text 300 1112 -text "go!EAST"
...
.c create rectangle 108 1126 172 1146 -fill white -width 0
.c create text 140 1136 -text "go?EAST"
...
.c create rectangle 103 1150 177 1170 -fill white -width 0
.c create text 140 1160 -text "go EAST"
...
.c create text 300 1184 -text "go!EAST"
...
.c create text 140 1208 -text "go?EAST"
...
.c create text 140 1232 -text "go EAST"
...
.c create rectangle 263 1246 337 1266 -fill white -width 0
.c create text 300 1256 -text "go!NORTH"
...
.c create rectangle 103 1270 177 1290 -fill white -width 0
.c create text 140 1280 -text "go?NORTH"
...
.c create rectangle 98 1294 182 1314 -fill white -width 0
.c create text 140 1304 -text "go NORTH"
...
.c create rectangle 268 1390 332 1410 -fill white -width 0
.c create text 300 1400 -text "go!WEST"
...
.c create rectangle 108 1414 172 1434 -fill white -width 0
.c create text 140 1424 -text "go?WEST"
...
.c create rectangle 103 1438 177 1458 -fill white -width 0
.c create text 140 1448 -text "go WEST"
...
.c create text 300 1472 -text "go!WEST"
...
.c create text 140 1496 -text "go?WEST"
...
.c create rectangle 103 1510 177 1530 -fill white -width 0
.c create text 140 1520 -text "go WEST"
.c create line 300 1554 220 1554 -fill darkblue -tags mesg -width 2
.c create line 220 1554 140 1554 -fill darkblue -width 2 -arrow last -arrowshape {5 5 5} -tags mesg
.c raise mesg
.c create text 70 1544 -fill #eef -text "127"
.c create line 140 1544 300 1544 -fill #eef -dash {6 4}
.c create line 300 1488 300 1532 -fill lightgrey -tags grid -width 1 
.c lower grid
# ProcLine[2] from 121 to 127 (Used 1 nobox 1)
# ProcLine[2] stays at 127 (Used 1 nobox 1)
.c create rectangle 268 1534 332 1554 -fill white -width 0
.c create text 300 1544 -text "go!EXIT"
.c create text 70 1568 -fill #eef -text "129"
.c create line 140 1568 300 1568 -fill #eef -dash {6 4}
.c create line 140 1536 140 1556 -fill lightgrey -tags grid -width 1 
.c lower grid
# ProcLine[1] from 125 to 129 (Used 1 nobox 1)
# ProcLine[1] stays at 129 (Used 1 nobox 1)
.c create rectangle 108 1558 172 1578 -fill white -width 0
.c create text 140 1568 -text "go?EXIT"
...
.c create rectangle 103 1582 177 1602 -fill white -width 0
.c create text 140 1592 -text "go EXIT"
.c lower grid
.c raise mesg

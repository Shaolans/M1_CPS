...
#define nstates4	11	/* :init: */
#define minseq4	36
#define maxseq4	45
#define endstate4	10

#define nstates3	7	/* sensor */
#define minseq3	30
#define maxseq3	35
#define endstate3	6

#define nstates2	14	/* feu */
#define minseq2	17
#define maxseq2	29
#define endstate2	13

#define nstates1	2	/* controle */
#define minseq1	16
#define maxseq1	16
#define endstate1	1

#define nstates0	17	/* train */
#define minseq0	0
#define maxseq0	15
#define endstate0	16
...
#define Air4	(sizeof(P4) - Offsetof(P4, signalout2) - 1*sizeof(uchar))

#define Psensor	((P3 *)this)
typedef struct P3 { /* sensor */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Air3	(sizeof(P3) - Offsetof(P3, signal) - 1*sizeof(uchar))

#define Pfeu	((P2 *)this)
typedef struct P2 { /* feu */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Air2	(sizeof(P2) - Offsetof(P2, color) - 1*sizeof(uchar))

#define Pcontrole	((P1 *)this)
typedef struct P1 { /* controle */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Air1	(sizeof(P1) - Offsetof(P1, switch2) - 1*sizeof(uchar))

#define Ptrain	((P0 *)this)
typedef struct P0 { /* train */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, color) - 1*sizeof(uchar))

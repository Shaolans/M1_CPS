...
#define _nstates1	31	/* proc2 */
#define minseq1	30
#define maxseq1	59
#define _endstate1	30

#define _nstates0	31	/* proc1 */
#define minseq0	0
#define maxseq0	29
...
#define Air1	(sizeof(P1) - Offsetof(P1, msec) - 1*sizeof(int))
...
#define Air0	(sizeof(P0) - Offsetof(P0, msec) - 1*sizeof(int))

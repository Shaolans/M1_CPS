...
short src_ln1 [] = {
	  0,  17,  18,  21,  21,  25,  25,  25, 
	 26,  26,  26,  24,  29,  31,  31,  31, 
	 32,  32,  32,  30,  35,  37,  37,  37, 
	 38,  38,  38,  36,  41,  42,  42,  46, 
	 46,  46,  47,  47,  47,  45,  50,  52, 
	 52,  52,  53,  53,  53,  51,  56,  58, 
	 58,  58,  59,  59,  59,  60,  60,  60, 
	 57,  63,  65,  65,  65,  66,  66,  66, 
	 64,  69,  71,  71,  71,  72,  72,  72, 
	 70,  75,  76,  76,  80,  80,  80,  81, 
	 81,  81,  82,  82,  82,  79,  85,  86, 
	 86,  90,  90,  90,  91,  91,  91,  89, 
	 94,  96,  96,  96,  97,  97,  97,  95, 
	100, 102, 102, 102, 103, 103, 103, 101, 
	106, 108, 108, 108, 109, 109, 109, 107, 
	112, 114, 114, 114, 115, 115, 115, 113, 
	118, 120, 120, 120, 121, 121, 121, 119, 
	124, 125, 125, 128, 128, 132, 134,   0, };
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "laby.pml", 1, 142 },
	{ "-", 143, 144 }
...
{	int j, h = now._nr_pr;
	...
	case 0:	/* observateur */
		...
		((P0 *)pptr(h))->dir = 0;
#ifdef VAR_RANGES
		logval("observateur:dir", ((P0 *)pptr(h))->dir);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
...
{
		now.go = addqueue(calling_pid, 1, 1);
#ifdef VAR_RANGES
#endif
}
...
{	int i = 0;
	...
	{	if (t->ty[i] == TIMEOUT_F) return 1;
		...
		switch (t->qu[i]) {
		case 0: break;
		case 1: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( now.go) )))
